...
function routes(app) {
  ...
  // Todo:加鉴权
  app.put('/user' + ('' + _index.baseUrl), function (req, res) {
    var url = req.db.url;
    var _req$params = req.params;
    var id = _req$params.id;
    var collectionName = _req$params.collectionName;

    (0, _index3.default)(url).updateById(collectionName, req.body).then(function (data) {
      return res.json(data);
    }).catch(function (err) {
  ...
  app.put(_index.baseUrl, function (req, res) {
    var url = req.db.url;
    var _req$params4 = req.params;
    var id = _req$params4.id;
    var collectionName = _req$params4.collectionName;
  ...
  app.delete(_index.baseUrl + '/:id', function (req, res) {
    var url = req.db.url;
    var _req$params5 = req.params;
    var id = _req$params5.id;
    var collectionName = _req$params5.collectionName;
